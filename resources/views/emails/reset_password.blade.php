...
<body style="font-family: sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="background-color: white; max-width: 600px; margin: auto; padding: 40px; border-radius: 20px;">
        ...
        <p>Halo,</p>
        <p>Kami menerima permintaan untuk mengatur ulang kata sandi akun Anda di <strong>Portal Magang PT GI</strong>. Silakan klik tombol di bawah ini untuk melanjutkan:</p>
        
        <div style="text-align: center; margin: 40px 0;">
            <a href="{{ route('password.reset', ['token' => $token, 'email' => $email]) }}" class="btn">RESET KATA SANDI</a>
        </div>
