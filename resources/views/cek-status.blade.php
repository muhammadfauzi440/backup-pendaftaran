        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sm:p-8">
            ...
            <div class="space-y-4">
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                        class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-red-600 disabled:pointer-events-none disabled:opacity-50 bg-red-600 text-white shadow hover:bg-red-600/90 h-10 px-4 py-2 sm:w-auto w-full"
                        onclick="cekStatus()">
                        Cek Status
                    </button>
                </div>
