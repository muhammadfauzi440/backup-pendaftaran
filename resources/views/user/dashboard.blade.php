        ...
        <div class="flex-1 flex flex-col transition-all duration-300" :class="sidebarOpen ? 'ml-64' : 'ml-20'">
            <header class="h-20 bg-white border-b border-gray-100 flex items-center px-8 sticky top-0 z-40">
                <button @click="sidebarOpen = !sidebarOpen"
                    class="p-2 hover:bg-gray-50 rounded-lg text-gray-500 transition">
                ...
                @else
                    <div class="max-w-5xl mx-auto">
                        <h1 class="text-4xl font-black text-gray-900 mb-2 uppercase tracking-tighter italic">Halo,
                            {{ auth()->user()->name }}! 👋</h1>
                        <p class="text-gray-500 mb-10 text-lg">Selamat datang di portal magang PT Global Intermedia
                            Nusantara.</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
                            ...
                            <div
                                ...
                                <a href="https://wa.me/6287782521039" target="_blank"
                                    class="relative z-10 inline-flex items-center justify-center gap-3 bg-white text-gray-900 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-red-600 hover:text-white transition-all shadow-xl">
