    ...
    <div class="max-w-6xl mx-auto py-8">
        <div class="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-10">
            <div>
                ...
                <p class="text-gray-500 font-bold text-sm">Total pengajuan masuk: <span class="text-red-600 font-black">{{ $pendaftarans->count() }} Pendaftar</span></p>
            </div>
                        ...
                        @forelse ($pendaftarans as $p)
                            <tr class="hover:bg-gray-50/50 transition duration-200">
                                ...
                                <td class="px-8 py-6 align-top">
                                    ...
                                    <div class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-3">{{ $p->nim_nisn }}</div>
                                ...
                                <td class="px-8 py-6 text-center align-top">
                                    <span class="inline-flex px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest
                                        {{ $p->status == 'pending' ? 'bg-amber-100 text-amber-600' : 
                                          ($p->status == 'diterima' ? 'bg-emerald-100 text-emerald-600 ' : 'bg-red-100 text-red-600') }}">
                                        {{ $p->status }}
                                    </span>
                                </td>
